    ...
    const messages = [
      {
        id: 1,
        role: 'ai',
        text: 'Hi Nitin 🌸 I can help you understand PCOS, periods, yoga, nutrition, and wellness routines.',
      },
      {
        id: 2,
        role: 'user',
        text: 'Can yoga help regulate irregular periods?',
      },
      {
        id: 3,
        role: 'ai',
        text: 'Yes 💕 Certain yoga practices may help reduce stress and support hormonal balance when combined with proper sleep, nutrition, and exercise.',
      },
    ];
  
    return (
      <div className="h-screen bg-[#FFF7FB] flex flex-col">
        {/* Header */}
        <div className="px-5 pt-6 pb-4 bg-white border-b border-pink-100 shadow-sm">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-gray-900">WombCare AI</h1>
